...
pvpfw_wg_mf_outroMarkUnits3DEH = addMissionEventHandler ["Draw3D",{
  ...
  _alpha = 0 max (1 min ((16.5 - _elapsed) / 4));
...
"pvpfw_wg_mf_fadeLayer" cutText ["","BLACK IN" ,1];
...
pvpfw_wg_mf_ppLayer1 ppEffectCommit 4;
...
[_text,0,0.0,_duration,0.5,0,"pvpfw_wg_mf_layer1"] spawn BIS_fnc_dynamicText;
//sleep 4;
...
[_text,0,0.2,_duration,0.5,0,"pvpfw_wg_mf_layer2"] spawn BIS_fnc_dynamicText;

sleep 20;

_text = "<t size='0.8' font='PuristaBold' shadow='2' color='#ffffffff'>" + "Debrief starts now." + "</t>";
[_text,0,0.9,_duration - 20,0.5,0,"pvpfw_wg_mf_layer3"] spawn BIS_fnc_dynamicText;
